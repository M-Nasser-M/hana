...
export interface ApiAddressAddress extends Schema.CollectionType {
  ...
  attributes: {
    ...
    governorate: Attribute.Relation<
      'api::address.address',
      'manyToOne',
      'api::governorate.governorate'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    name_en: Attribute.String & Attribute.Required & Attribute.Unique;
    name_ar: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiGovernorateGovernorate extends Schema.CollectionType {
  ...
  attributes: {
    governorate_name_ar: Attribute.String &
      Attribute.Required &
      Attribute.Unique;
    governorate_name_en: Attribute.String &
      Attribute.Required &
      Attribute.Unique;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    order_status: Attribute.Enumeration<
      ['ACCEPTED', 'PREPARED', 'OUT FOR DELIVERY', 'DELIVERED', 'CANCELED']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiRefundReturnRefundReturn extends Schema.SingleType {
  collectionName: 'refund_returns';
  info: {
    singularName: 'refund-return';
    pluralName: 'refund-returns';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::governorate.governorate': ApiGovernorateGovernorate;
      'api::home.home': ApiHomeHome;
      'api::order.order': ApiOrderOrder;
      'api::order-item.order-item': ApiOrderItemOrderItem;
      'api::privacy-policy.privacy-policy': ApiPrivacyPolicyPrivacyPolicy;
      'api::product.product': ApiProductProduct;
      'api::refund-return.refund-return': ApiRefundReturnRefundReturn;
